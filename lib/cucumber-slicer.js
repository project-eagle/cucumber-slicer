...
global.scenarioIndex = 0;
global.scenarioModulo = 3;

function writeSingleScenarioFile(dir, parsed, scenario, i, z = 0) {
  let output = getFeatureTop(parsed, i, mapOfGeneratedFeatureTags, global.scenarioIndex % global.scenarioModulo);
  global.scenarioIndex = global.scenarioIndex + 1;
...
function cucumberSlicer(featureFiles, splitDir, scenarioModulo = 3) {
  global.scenarioModulo = scenarioModulo;
